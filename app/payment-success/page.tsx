...
export default function PaymentSuccess() {
  useEffect(() => {
    const confetti = async () => {
      ...
      confettiLib({ particleCount: 150, spread: 80, origin: { y: 0.6 } })
      setTimeout(() => confettiLib({ particleCount: 100, angle: 60, spread: 55, origin: { x: 0 } }), 300)
      setTimeout(() => confettiLib({ particleCount: 100, angle: 120, spread: 55, origin: { x: 1 } }), 600)
    }
    confetti()
  }, [])
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: '#FFFDF5' }}>
      <div className="text-center max-w-md">
        ...
        <Link
          href="/dashboard"
          className="candy-btn px-8 py-4 text-lg flex items-center justify-center gap-3 w-full"
        >
