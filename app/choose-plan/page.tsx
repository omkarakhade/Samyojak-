...
const plans = {
  weekly: [
    { name: 'CRM Starter', price: '$4.99', bonus: '+1 week free', period: 'wk', features: ['CRM & Leads', 'Follow-ups', 'Up to 5 users', 'Email support'], emoji: '🌱', color: '#8B5CF6', bg: '#EDE9FE' },
    { name: 'ERP Basic', price: '$9.99', bonus: '+1 week free', period: 'wk', features: ['Inventory', 'Invoicing', 'GST reports', 'Up to 10 users'], emoji: '⚡', color: '#F472B6', bg: '#FCE7F3' },
    { name: 'Business', price: '$16.99', bonus: '+1 week free', period: 'wk', features: ['CRM + ERP + HR', 'Projects', 'Up to 25 users', 'Priority support'], emoji: '🚀', color: '#FBBF24', bg: '#FEF3C7', popular: true },
    { name: 'Complete', price: '$21.99', bonus: '+1 week free', period: 'wk', features: ['Everything', 'AI features', 'Unlimited users', 'API access'], emoji: '💎', color: '#34D399', bg: '#D1FAE5' },
  ],
  monthly: [
    { name: 'CRM Starter', price: '$15', bonus: '+1 month free', period: 'mo', features: ['CRM & Leads', 'Follow-ups', 'Up to 5 users', 'Email support'], emoji: '🌱', color: '#8B5CF6', bg: '#EDE9FE' },
    { name: 'ERP Basic', price: '$35', bonus: '+1 month free', period: 'mo', features: ['Inventory', 'Invoicing', 'GST reports', 'Up to 10 users'], emoji: '⚡', color: '#F472B6', bg: '#FCE7F3' },
    { name: 'Business', price: '$60', bonus: '+1 month free', period: 'mo', features: ['CRM + ERP + HR', 'Projects', 'Up to 25 users', 'Priority support'], emoji: '🚀', color: '#FBBF24', bg: '#FEF3C7', popular: true },
    { name: 'Complete', price: '$79', bonus: '+1 month free', period: 'mo', features: ['Everything', 'AI features', 'Unlimited users', 'API access'], emoji: '💎', color: '#34D399', bg: '#D1FAE5' },
  ],
  yearly: [
    { name: 'CRM Starter', price: '$144', bonus: '+2 months free', period: 'yr', features: ['CRM & Leads', 'Follow-ups', 'Up to 5 users', 'Email support'], emoji: '🌱', color: '#8B5CF6', bg: '#EDE9FE' },
    { name: 'ERP Basic', price: '$336', bonus: '+2 months free', period: 'yr', features: ['Inventory', 'Invoicing', 'GST reports', 'Up to 10 users'], emoji: '⚡', color: '#F472B6', bg: '#FCE7F3' },
    { name: 'Business', price: '$576', bonus: '+3 months free', period: 'yr', features: ['CRM + ERP + HR', 'Projects', 'Up to 25 users', 'Priority support'], emoji: '🚀', color: '#FBBF24', bg: '#FEF3C7', popular: true },
    { name: 'Complete', price: '$759', bonus: '+3 months free', period: 'yr', features: ['Everything', 'AI features', 'Unlimited users', 'API access'], emoji: '💎', color: '#34D399', bg: '#D1FAE5' },
  ],
}
    ...
    <div className="min-h-screen py-12 px-4" style={{ background: '#FFFDF5' }}>
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="text-lg mb-6" style={{ color: '#64748B', fontFamily: 'Plus Jakarta Sans' }}>
            Every plan includes a bonus period — pay once, get more.
          </p>

          <div className="flex justify-center gap-2 mb-2">
            {(['weekly', 'monthly', 'yearly'] as const).map(b => (
              <div key={b} className="text-xs px-3 py-1 rounded-full font-semibold" style={{ background: '#F1F5F9', color: '#475569' }}>
                {b === 'weekly' ? '📅 Weekly +1 wk free' : b === 'monthly' ? '📆 Monthly +1 mo free' : '🗓️ Yearly +2-3 mo free'}
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {plans[billing].map((plan) => (
            ...
            >
              ...
              <h3 className="font-black text-lg mb-1" style={{ fontFamily: 'Outfit', color: plan.popular ? 'white' : '#1E293B' }}>
                {plan.name}
              </h3>

              <div className="mb-3">
                <span className="text-4xl font-black" style={{ fontFamily: 'Outfit', color: plan.popular ? 'white' : '#1E293B' }}>
                  {plan.price}
                </span>
        ...
        <p className="text-center text-sm mt-8" style={{ color: '#94A3B8', fontFamily: 'Plus Jakarta Sans' }}>
          🔒 Secure payment · Cancel anytime · Bonus time added automatically after payment
        </p>
      </div>
    </div>
  )
