  ...
  if (!open) {
    return (
      ...
      >
        <Search size={14} />
        <span>Search...</span>
        <kbd className="ml-2 text-xs bg-gray-200 dark:bg-white/20 px-2 py-0.5 rounded font-mono">
          ⌘K
        </kbd>
      </button>
    )
      ...
      <div className="bg-white dark:bg-[#1a2740] rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden">
        <div className="flex items-center gap-3 p-4 border-b border-gray-100 dark:border-white/10">
          ...
          <input
            ...
            aria-label="Search leads, invoices and products"
            value={query}
